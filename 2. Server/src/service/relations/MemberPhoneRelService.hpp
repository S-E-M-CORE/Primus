...
public:
     ...
     */
    oatpp::Object<MemberPhoneRelDTO> createMemberPhoneRel(const oatpp::Object<MemberPhoneRelDTO>& rel);
     ...
     */
    oatpp::Object<StatusDTO> deleteMemberPhoneRel(const oatpp::Int64& memberId, const oatpp::Int64& phoneNumberId);
     ...
     */
    oatpp::Vector<oatpp::Int64> getPhoneIdsByMemberId(const oatpp::Int64& memberId);
     ...
     */
    oatpp::Vector<oatpp::Int64> getMemberIdsByPhoneId(const oatpp::Int64& phoneNumberId);
};
